...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // If company name was provided, fetch company info to show slug
      if (companyName) {
        try {
          ...
          // Company might not be created yet, that's okay
          ...
          <div className="rounded-md shadow-sm space-y-4">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500">
                You can create your company now or add it later from the dashboard.
              </p>
            </div>
          </div>
